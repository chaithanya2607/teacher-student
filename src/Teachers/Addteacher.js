...
const userValidationSchema = yup.object({
  teachername: yup.string().required("Why not fill the teachername?"),
  Qualification: yup.string().required("why not fill the qualification?"),
});
...
export default function Addteacher() {
  ...
  const createTeacher = (newTeacher) => {
    ...
    fetch("https://63234c53bb2321cba916eb6e.mockapi.io/teacher", {
      method: "POST",
